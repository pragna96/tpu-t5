    ...
    def __post_init__(self):
        if self.dataset_name is None and self.train_file is None and self.validation_file is None:
            ...
            if self.train_file is not None:
                ...
                assert extension in ["tsv","csv", "json", "txt"], "`train_file` should be a csv, a json or a txt file."
...
def main():
    ...
    if training_args.push_to_hub:
        print("Check",Path(training_args.output_dir).absolute().name)
    ...
    if data_args.dataset_name is not None:
        ...
        print("Check1",data_args.dataset_config_name)
        datasets = load_dataset(data_args.dataset_name,data_args.dataset_config_name, cache_dir=model_args.cache_dir, delimiter="\t")
        ...
        if extension == "tsv":
            extension = "csv"
        print("Check1",model_args.cache_dir)
